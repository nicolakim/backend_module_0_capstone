...
# The `if` statement takes a boolean expression (a statement that is either _true_ or _false_) and executes certain code only if the boolean expression is _true_.
# If it is _false_, it doesn't execute the code.
